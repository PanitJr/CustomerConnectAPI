...
CREATE TABLE `cc_btsstations` (
  ...
  `btsstationname_eng` int(11) NOT NULL,
  `btsstationcode` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cc_expenses` VALUES (0,4,'eatheat',NULL,NULL,0.00,0,0,'',0),(0,5,'t4hsrtn',NULL,NULL,0.00,0,0,'',0),(0,14,'n','0000-00-00 00:00:00',NULL,254.00,0,0,'h,k',0),(1,15,'john@example.com',NULL,NULL,500.00,0,0,'',0),(1,16,'john@example.com',NULL,NULL,500.00,0,0,'',0),(1,17,'john@example.com',NULL,NULL,500.00,0,0,'',0);
...
INSERT INTO `cc_items` VALUES (2,'hhhhh','0','',0.00,'','','0','0000-00-00'),(3,'theqtheth','0','',0.00,'','','0','0000-00-00'),(7,'u9pbp','0','',0.00,'','','0','0000-00-00'),(41,'test item','Travel','asfcas',132.00,'','','','0000-00-00'),(43,'ascsa','Travel','scsac',453.00,'','','','0000-00-00'),(45,'ghmcg','Travel','cgj,cg',4545.00,'cghmcghm','','','0000-00-00'),(47,'panit','Medical','crm',50.00,'','','','0000-00-00'),(49,'ไปตามหาพระไตรปิดก','Travel','อาร์ ที เอช',500.00,'พระถังซัมจั๋งงงง เดินทาง ไปชมพูทวีป ด้วยพรหม วิเศสใส่','http://localhost:8000/object_image/Item/49/attachment.png?12b9f69ba3faec3017d5ef88f763f5ee','','2559-11-06');
...
--
-- Table structure for table `cc_leaveavailables`
--

DROP TABLE IF EXISTS `cc_leaveavailables`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cc_leaveavailables` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `cc_leaveavailables`
--

LOCK TABLES `cc_leaveavailables` WRITE;
/*!40000 ALTER TABLE `cc_leaveavailables` DISABLE KEYS */;
/*!40000 ALTER TABLE `cc_leaveavailables` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `cc_leaveuseds`
--

DROP TABLE IF EXISTS `cc_leaveuseds`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cc_leaveuseds` (
  `id` int(11) NOT NULL,
  `leaveused` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `userid` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `cc_leaveuseds`
--

LOCK TABLES `cc_leaveuseds` WRITE;
/*!40000 ALTER TABLE `cc_leaveuseds` DISABLE KEYS */;
/*!40000 ALTER TABLE `cc_leaveuseds` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `cc_medicals` VALUES (48,'',47,'');
...
INSERT INTO `cc_travels` VALUES (1,'1','kkkkkk','hhhhhh',20.00,'1','0',2),(9,'1','ghmjcghm','cgh,cgj,',20.00,'1','1',2),(11,'1','yfukyf','hi;ii;',50.00,'2','1',2),(12,'1','xfgnxgn','xfng',45.00,'1','1',2),(39,'','dtym','dtymdt',0.00,'','',0),(40,'','cghm','gm g',0.00,'Public Transport','BTS',0),(42,'','cas','csas',0.00,'Public Transport','BTS',0),(44,'','asc','fwwqf',0.00,'Public Transport','BTS',0),(46,'','cgj,cgj,','mhcg',0.00,'Public Transport','BTS',45),(50,'','ชมพูทวิป','เกาะ เกร็ด',0.00,'Public Transport','BRT',49);
...
INSERT INTO `cc_travelsubtypes` VALUES (53,'Airport Rail Link Station'),(54,'BRT'),(55,'BTS'),(56,'MRT'),(57,'Taxi'),(58,'Bus'),(59,'Van'),(60,'Boat'),(61,'Tuk Tuk'),(62,'Airplane'),(63,'Motorcycle Taxi'),(64,'Taxi App');
...
INSERT INTO `cc_traveltypes` VALUES (51,'Public Transport'),(52,'Private Transport');
...
INSERT INTO `object_field_type` VALUES (1,'reference'),(2,'image');
...
-- Dump completed on 2016-11-08 22:44:13
