...
Route::group(['prefix' => 'api' ,"middleware" =>['cors','GZip']], function () {
	...
	Route::group(['middleware'=>"App\Http\Middleware\VerifyApiToken"],function(){		
		...
		Route::get('{objectName}/detail/{record}', objectRun('LeaveDetail'));
        Route::get('{objectName}/leavelist/{record}', objectRun('LeaveList'));
        Route::get('{objectName}/edit/{record}', objectRun('LeaveEdit'));
